...
function login(usuario) {
    return __awaiter(this, void 0, void 0, function () {
        var userLogin, passwordValid, msg, token, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, user_1.userSchema.findOne({ username: usuario.username })];
                case 1:
                    userLogin = _a.sent();
                    console.log(userLogin);
                    if (!user_1.userSchema) {
                        return [2 /*return*/, false];
                    }
                    passwordValid = bcrypt.compareSync(usuario.password, userLogin.password);
                    if (!passwordValid) {
